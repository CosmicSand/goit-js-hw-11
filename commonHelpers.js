...
</li>`;a.insertAdjacentHTML("beforeend",u)}),new f(".gallery a",{captionsData:"alt",captionDelay:250,className:"lightbox-on"}),l.reset()}function b(){h.insertAdjacentHTML("afterbegin",'<span class="loader"></span>')}function w(){document.querySelector(".loader").remove()}
