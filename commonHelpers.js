...
</li>`).join("");c.insertAdjacentHTML("beforeend",o),new p(".gallery a",{captionsData:"alt",captionDelay:250,className:"lightbox-on"}),a.reset()}function h(){f.insertAdjacentHTML("afterbegin",'<span class="loader"></span>')}function l(){document.querySelector(".loader").remove()}
