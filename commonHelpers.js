...
</li>`).join("");p.insertAdjacentHTML("beforeend",r),h.refresh(),l.reset()}function L(){g.insertAdjacentHTML("afterbegin",'<span class="loader"></span>'),n.disabled=!0,n.classList.add("search-btn-disabled")}function d(){document.querySelector(".loader").remove(),n.disabled=!1,n.classList.remove("search-btn-disabled"),l.reset()}
