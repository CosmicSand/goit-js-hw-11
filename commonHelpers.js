...
</li>`).join("");a.insertAdjacentHTML("beforeend",o),new d(".gallery a",{captionsData:"alt",captionDelay:250,className:"lightbox-on"}),l.reset()}function g(){u.insertAdjacentHTML("afterbegin",'<span class="loader"></span>')}function h(){document.querySelector(".loader").remove()}
