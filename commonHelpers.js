...
</li>`).join("");d.insertAdjacentHTML("beforeend",s),g.refresh(),l.reset()}function L(){f.insertAdjacentHTML("afterbegin",'<span class="loader"></span>')}function c(){document.querySelector(".loader").remove()}
